...
insert into PERSON values ('Michael Michael', '441 Loomis Lane', 'Tacoma', '0123456789', '', '2015/06/12');
insert into PERSON values ('Meera Sakshi', '8519 Sycamore Parkway', 'Topeka', '0213456789', '', '2012/06/11');
insert into PERSON values ('Safiya Irene', '238 Dorton Way', 'Fairfax', '0312456789', '', '1995/10/20');
insert into PERSON values ('George Zoghindy', '4406 Fairfield Center', 'Huntington', '0412356789', '', '1931/08/09');
insert into PERSON values ('Patrick Johnson', '55 Valley Edge Drive', 'Kansas City', '0512346789', '', '2001/04/02');
insert into PERSON values ('Denise Simmons', '7 Carberry Park', 'Phoenix', '0612345789', '', '1961/12/19');
insert into PERSON values ('Lara Gall', '30269 Arizona Junction', 'Saint Petersburg', '0712345689', '', '1976/04/09');
insert into PERSON values ('Karen Reed', '8067 Cottonwood Crossing', 'Birmingham', '0812345679', '', '2011/12/06');
insert into PERSON values ('Chris Turner', '05 Sycamore Plaza', 'Brooklyn', '0912345678', '', '1945/09/20');
insert into PERSON values ('Joseph Samadi', '5 Dennis Street', 'Jackson', '0132456789', '', '1984/04/01');
insert into PERSON values ('Brandon Perez', '3664 Stoughton Crossing', 'Atlanta', '0142356789', '', '1984/10/11');
insert into PERSON values ('Stephanie Ross', '4595 Kensington Pass', 'Springfield', '0152346789', '', '1961/05/22');
insert into PERSON values ('Donald Russell', '52859 Tony Drive', 'Jackson', '0162345789', '', '1994/07/16');
insert into PERSON values ('Patricia Butler', '91501 Grasskamp Court', 'Amarillo', '0172345689', '', '1970/10/04');
insert into PERSON values ('Diana Robinson', '3 Hoard Pass', 'Sacramento', '0182345679', '', '1944/4/11');
insert into PERSON values ('Nuzhat Zaman', '5358 Summit Center', 'Pittsburgh', '0192345678', '', '1951/11/21');
insert into PERSON values ('Cornelius Adisa', '50445 Melby Avenue', 'Fort Worth', '0231456789', '', '1977/07/23');
insert into PERSON values ('Wendell Gray', '537 Rutledge Drive', 'Fresno', '0241356789', '', '1960/07/23');
insert into PERSON values ('Pamela Ida', '70 Summer Ridge Lane', 'Lake Charles', '0251346789', '', '1976/12/06');
insert into PERSON values ('Jose Garcia', '546 Red Cloud Point', 'Augusta', '0261345789', '', '2001/07/08');



insert into PERSON values ('Patrick Grant', '0 Summit Place', 'Winston Salem', '0271345689', '', '1993/01/22');
insert into PERSON values ('Wanda Wallace', '05 Debra Avenue', 'Lincoln', '0281345679', '', '1980/09/17');
insert into PERSON values ('Albert Chapman', '1652 Pepper Wood Road', 'Houston', '0291345678', '', '1959/05/02');
insert into PERSON values ('Christina Ross', '23 Autumn Leaf Road', 'Jeffersonville', '0422456789', '', '1952/09/27');
insert into PERSON values ('Phyllis Burns', '19 Kinsman Plaza', 'Toledo', '0321456789', '', '1981/07/20');
insert into PERSON values ('Amy Rice', '7068 Westport Avenue', 'West Palm Beach', '0341256789', '', '1987/08/14');
insert into PERSON values ('Aaron Ray', '17 Merrick Lane', 'Indianapolis', '0351246789', '', '1961/05/15');
insert into PERSON values ('James Ray', '8806 Sachs Pass', 'Minneapolis', '0361245789', '', '1994/02/12');
insert into PERSON values ('Irene Bailey', '395 Upham Lane', 'Newton', '0371245689', '', '2016/04/03');
insert into PERSON values ('Wayne Myers', '0 Iowa Park', 'Columbus', '0381245679', '', '1978/06/19');
insert into PERSON values ('Linda Ramos', '010 Farragut Terrace', 'Fort Wayne', '0391245678', '', '1967/07/26');
insert into PERSON values ('Stephanie Hart', '8899 Tennessee Park', 'Charleston', '0421245678', '', '1936/12/18');
insert into PERSON values ('Amy Reed', '58 Loeprich Way', 'Lawrenceville', '0300451234', '', '1942/04/14');
insert into PERSON values ('Phyllis Watkins', '6562 Onsgard Pass', 'Colorado Springs', '0809301234', '', '2000/11/30');
insert into PERSON values ('Bruce Foster', '09 Shasta Junction', 'Honolulu', '0968251234', '', '1994/09/16');
insert into PERSON values ('Russell Phillips', '18850 Sutteridge Circle', 'Yakima', '0989079876', '', '2003/01/20');
insert into PERSON values ('Lisa Carroll', '709 Saint Paul Junction', 'Mesa', '0852059876', '', '1944/04/30');
insert into PERSON values ('Dennis Frazier', '3 Lien Court', 'Omaha', '0681975643', '', '2001/03/26');
insert into PERSON values ('Evelyn Bailey', '271 Summer Ridge Court', 'Tallahassee', '0323998765', '', '1978/03/07');
insert into PERSON values ('Scott Wallace', '3844 Iowa Park', 'Saint Petersburg', '0337159876', '', '1991/04/16');



insert into VISITOR values ('35725953', 'Child', '2010/03/08', 'Patrick Grant');
insert into VISITOR values ('35642460', 'Child', '2010/07/10', 'Wanda Wallace');
insert into VISITOR values ('20169288', 'Child', '2013/01/26', 'Albert Chapman');
insert into VISITOR values ('67633330', 'Child', '2015/02/14', 'Christina Ross');
insert into VISITOR values ('56022177', 'Child', '2015/04/13', 'Phyllis Burns');
insert into VISITOR values ('35704041', 'Adult', '2012/08/09', 'Amy Rice');
insert into VISITOR values ('56022334', 'Child', '2016/08/13', 'Aaron Ray');
insert into VISITOR values ('35421887', 'Child', '2015/09/21', 'James Ray');
insert into VISITOR values ('50483717', 'Child', '2010/03/03', 'Irene Bailey');
insert into VISITOR values ('50076647', 'Child', '2011/12/21', 'Wayne Myers');
insert into VISITOR values ('51001403', 'Child', '2016/06/05', 'Linda Ramos');
insert into VISITOR values ('30081856', 'Child', '2011/09/04', 'Stephanie Hart');
insert into VISITOR values ('48415204', 'Adult', '2010/08/10', 'Amy Reed');
insert into VISITOR values ('54922569', 'Adult', '2014/05/08', 'Phyllis Watkins');
insert into VISITOR values ('35801019', 'Adult', '2013/01/23', 'Bruce Foster');
insert into VISITOR values ('35551133', 'Adult', '2015/02/13', 'Russell Phillips');
insert into VISITOR values ('35715531', 'Child', '2012/08/06', 'Lisa Carroll');
insert into VISITOR values ('35483582', 'Adult', '2014/08/12', 'Dennis Frazier');
insert into VISITOR values ('35280968', 'Child', '2013/07/13', 'Evelyn Bailey');
insert into VISITOR values ('67625461', 'Adult', '2011/08/24', 'Scott Wallace');
